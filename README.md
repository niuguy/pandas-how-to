...
5. [How to get a list of column headers](Python-notebooks/How-to-get-a-list-of-column-headers.ipynb)
6. [How to add new column to existing DataFrame](Python-notebooks/How-to-add-new-column-to-existing-DataFrame.ipynb)
7. [How to select multiple columns](Python-notebooks/How-to-select-multiple-columns.ipynb)
